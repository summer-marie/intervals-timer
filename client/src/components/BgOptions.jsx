  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed top-4 left-4 z-50 bg-white/20 backdrop-blur-sm text-white p-3 rounded-full hover:bg-white/30 transition-all duration-300 ${
          isOpen ? 'rotate-180' : ''
        }`}
      ...
      <div className={`fixed top-0 left-0 h-full bg-black/50 backdrop-blur-lg z-40 transition-transform duration-300 ease-in-out ${
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-white/20">
          <button
            ...
            className="w-full bg-white/10 hover:bg-white/20 text-white py-2 px-4 rounded-lg transition-colors duration-200 text-sm"
          >
            Close
          </button>
        </div>
